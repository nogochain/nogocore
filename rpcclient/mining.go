...
func (c *Client) GenerateAsync(numBlocks uint32) FutureGenerateResult {
	cmd := nogojson.NewGenerateCmd(numBlocks)
...
func (c *Client) GenerateToAddressAsync(numBlocks int64,
	...
	cmd := nogojson.NewGenerateToAddressCmd(numBlocks, address.EncodeAddress(), maxTries)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetGenerateAsync() FutureGetGenerateResult {
	cmd := nogojson.NewGetGenerateCmd()
	return c.SendCmd(cmd)
}
...
func (c *Client) SetGenerateAsync(enable bool, numCPUs int) FutureSetGenerateResult {
	cmd := nogojson.NewSetGenerateCmd(enable, &numCPUs)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetHashesPerSecAsync() FutureGetHashesPerSecResult {
	cmd := nogojson.NewGetHashesPerSecCmd()
	return c.SendCmd(cmd)
}
...
// information.
func (r FutureGetMiningInfoResult) Receive() (*nogojson.GetMiningInfoResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoResult nogojson.GetMiningInfoResult
...
func (c *Client) GetMiningInfoAsync() FutureGetMiningInfoResult {
	cmd := nogojson.NewGetMiningInfoCmd()
	return c.SendCmd(cmd)
}

// GetMiningInfo returns mining information.
func (c *Client) GetMiningInfo() (*nogojson.GetMiningInfoResult, error) {
...
func (c *Client) GetNetworkHashPS2Async(blocks int) FutureGetNetworkHashPS {
	cmd := nogojson.NewGetNetworkHashPSCmd(&blocks, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetNetworkHashPS3Async(blocks, height int) FutureGetNetworkHashPS {
	cmd := nogojson.NewGetNetworkHashPSCmd(&blocks, &height)
	return c.SendCmd(cmd)
}
...
// data to work on.
func (r FutureGetWork) Receive() (*nogojson.GetWorkResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var result nogojson.GetWorkResult
	err = json.Unmarshal(res, &result)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetWorkAsync() FutureGetWork {
	cmd := nogojson.NewGetWorkCmd(nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetWork() (*nogojson.GetWorkResult, error) {
...
func (c *Client) GetWorkSubmitAsync(data string) FutureGetWorkSubmit {
	cmd := nogojson.NewGetWorkCmd(&data)
	return c.SendCmd(cmd)
}
...
func (c *Client) SubmitBlockAsync(block *nogoutil.Block, options *nogojson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
	...
	cmd := nogojson.NewSubmitBlockCmd(blockHex, options)
	return c.SendCmd(cmd)
}

// SubmitBlock attempts to submit a new block into the bitcoin network.
func (c *Client) SubmitBlock(block *nogoutil.Block, options *nogojson.SubmitBlockOptions) error {
...
func (r FutureGetBlockTemplateResponse) Receive() (*nogojson.GetBlockTemplateResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a getwork result object.
	var result nogojson.GetBlockTemplateResult
	err = json.Unmarshal(res, &result)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetBlockTemplateAsync(req *nogojson.TemplateRequest) FutureGetBlockTemplateResponse {
	cmd := nogojson.NewGetBlockTemplateCmd(req)
	return c.SendCmd(cmd)
}

// GetBlockTemplate returns a new block template for mining.
func (c *Client) GetBlockTemplate(req *nogojson.TemplateRequest) (*nogojson.GetBlockTemplateResult, error) {
