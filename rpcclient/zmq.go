...
func (r FutureGetZmqNotificationsResult) Receive() (nogojson.GetZmqNotificationResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	var notifications nogojson.GetZmqNotificationResult
...
func (c *Client) GetZmqNotificationsAsync() FutureGetZmqNotificationsResult {
	return c.SendCmd(nogojson.NewGetZmqNotificationsCmd())
}

// GetZmqNotifications returns information about the active ZeroMQ notifications.
func (c *Client) GetZmqNotifications() (nogojson.GetZmqNotificationResult, error) {
