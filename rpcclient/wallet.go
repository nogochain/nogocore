...
func (r FutureGetTransactionResult) Receive() (*nogojson.GetTransactionResult, error) {
	...
	var getTx nogojson.GetTransactionResult
...
func (c *Client) GetTransactionAsync(txHash *chainhash.Hash) FutureGetTransactionResult {
	...
	cmd := nogojson.NewGetTransactionCmd(hash, nil)
...
func (c *Client) GetTransaction(txHash *chainhash.Hash) (*nogojson.GetTransactionResult, error) {
...
func (c *Client) GetTransactionWatchOnlyAsync(txHash *chainhash.Hash, watchOnly bool) FutureGetTransactionResult {
	...
	cmd := nogojson.NewGetTransactionCmd(hash, &watchOnly)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetTransactionWatchOnly(txHash *chainhash.Hash, watchOnly bool) (*nogojson.GetTransactionResult, error) {
...
func (r FutureListTransactionsResult) Receive() ([]nogojson.ListTransactionsResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var transactions []nogojson.ListTransactionsResult
...
func (c *Client) ListTransactionsAsync(account string) FutureListTransactionsResult {
	cmd := nogojson.NewListTransactionsCmd(&account, nil, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListTransactions(account string) ([]nogojson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountAsync(account string, count int) FutureListTransactionsResult {
	cmd := nogojson.NewListTransactionsCmd(&account, &count, nil, nil)
	return c.SendCmd(cmd)
}
...
// different options.
func (c *Client) ListTransactionsCount(account string, count int) ([]nogojson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountFromAsync(account string, count, from int) FutureListTransactionsResult {
	cmd := nogojson.NewListTransactionsCmd(&account, &count, &from, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListTransactionsCountFrom(account string, count, from int) ([]nogojson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountFromWatchOnlyAsync(account string, count, from int, watchOnly bool) FutureListTransactionsResult {
	cmd := nogojson.NewListTransactionsCmd(&account, &count, &from, &watchOnly)
	return c.SendCmd(cmd)
}
...
//
// See the ListTransactions and ListTransactionsCount functions to use defaults.
func (c *Client) ListTransactionsCountFromWatchOnly(account string, count, from int, watchOnly bool) ([]nogojson.ListTransactionsResult, error) {
...
func (r FutureListUnspentResult) Receive() ([]nogojson.ListUnspentResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var unspent []nogojson.ListUnspentResult
...
func (c *Client) ListUnspentAsync() FutureListUnspentResult {
	cmd := nogojson.NewListUnspentCmd(nil, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListUnspentMinAsync(minConf int) FutureListUnspentResult {
	cmd := nogojson.NewListUnspentCmd(&minConf, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAsync(minConf, maxConf int) FutureListUnspentResult {
	cmd := nogojson.NewListUnspentCmd(&minConf, &maxConf, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int,
	...
	cmd := nogojson.NewListUnspentCmd(&minConf, &maxConf, &addrStrs)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListUnspent() ([]nogojson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMin(minConf int) ([]nogojson.ListUnspentResult, error) {
...
// a filter.
func (c *Client) ListUnspentMinMax(minConf, maxConf int) ([]nogojson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int,
	addrs []address.Address) ([]nogojson.ListUnspentResult, error) {
...
func (r FutureListSinceBlockResult) Receive() (*nogojson.ListSinceBlockResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var listResult nogojson.ListSinceBlockResult
...
func (c *Client) ListSinceBlockAsync(blockHash *chainhash.Hash) FutureListSinceBlockResult {
	var hash *string
	if blockHash != nil {
		hash = nogojson.String(blockHash.String())
	}

	cmd := nogojson.NewListSinceBlockCmd(hash, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListSinceBlock(blockHash *chainhash.Hash) (*nogojson.ListSinceBlockResult, error) {
...
func (c *Client) ListSinceBlockMinConfAsync(blockHash *chainhash.Hash, minConfirms int) FutureListSinceBlockResult {
	...
	cmd := nogojson.NewListSinceBlockCmd(hash, &minConfirms, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListSinceBlockMinConf(blockHash *chainhash.Hash, minConfirms int) (*nogojson.ListSinceBlockResult, error) {
...
func (c *Client) ListSinceBlockMinConfWatchOnlyAsync(blockHash *chainhash.Hash, minConfirms int, watchOnly bool) FutureListSinceBlockResult {
	...
	cmd := nogojson.NewListSinceBlockCmd(hash, &minConfirms, &watchOnly)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListSinceBlockMinConfWatchOnly(blockHash *chainhash.Hash, minConfirms int, watchOnly bool) (*nogojson.ListSinceBlockResult, error) {
...
func (c *Client) LockUnspentAsync(unlock bool, ops []*wire.OutPoint) FutureLockUnspentResult {
	outputs := make([]nogojson.TransactionInput, len(ops))
	for i, op := range ops {
		outputs[i] = nogojson.TransactionInput{
			Txid: op.Hash.String(),
			Vout: op.Index,
		}
	}
	cmd := nogojson.NewLockUnspentCmd(unlock, outputs)
	return c.SendCmd(cmd)
}
...
func (r FutureListLockUnspentResult) Receive() ([]*wire.OutPoint, error) {
	...
	var inputs []nogojson.TransactionInput
...
func (c *Client) ListLockUnspentAsync() FutureListLockUnspentResult {
	cmd := nogojson.NewListLockUnspentCmd()
	return c.SendCmd(cmd)
}
...
func (c *Client) SetTxFeeAsync(fee nogoutil.Amount) FutureSetTxFeeResult {
	cmd := nogojson.NewSetTxFeeCmd(fee.ToBTC())
	return c.SendCmd(cmd)
}
...
func (c *Client) SetTxFee(fee nogoutil.Amount) error {
...
func (c *Client) SendToAddressAsync(address address.Address,
	amount nogoutil.Amount) FutureSendToAddressResult {

	addr := address.EncodeAddress()
	cmd := nogojson.NewSendToAddressCmd(addr, amount.ToBTC(), nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) SendToAddress(address address.Address,
	amount nogoutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address address.Address,
	amount nogoutil.Amount, comment,
	commentTo string) FutureSendToAddressResult {

	addr := address.EncodeAddress()
	cmd := nogojson.NewSendToAddressCmd(addr, amount.ToBTC(), &comment,
		&commentTo)
	return c.SendCmd(cmd)
}
...
func (c *Client) SendToAddressComment(address address.Address,
	amount nogoutil.Amount, comment, commentTo string) (*chainhash.Hash,
	error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress address.Address,
	amount nogoutil.Amount) FutureSendFromResult {

	addr := toAddress.EncodeAddress()
	cmd := nogojson.NewSendFromCmd(fromAccount, addr, amount.ToBTC(), nil,
		nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) SendFromMinConfAsync(fromAccount string,
	toAddress address.Address, amount nogoutil.Amount,
	minConfirms int) FutureSendFromResult {

	addr := toAddress.EncodeAddress()
	cmd := nogojson.NewSendFromCmd(fromAccount, addr, amount.ToBTC(),
		&minConfirms, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) SendFromMinConf(fromAccount string, toAddress address.Address,
	amount nogoutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress address.Address, amount nogoutil.Amount, minConfirms int,
...
func (c *Client) SendFromComment(fromAccount string, toAddress address.Address,
	amount nogoutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string,
	amounts map[address.Address]nogoutil.Amount) FutureSendManyResult {

	convertedAmounts := make(map[string]float64, len(amounts))
	for addr, amount := range amounts {
		convertedAmounts[addr.EncodeAddress()] = amount.ToBTC()
	}
	cmd := nogojson.NewSendManyCmd(fromAccount, convertedAmounts, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) SendMany(fromAccount string,
	amounts map[address.Address]nogoutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[address.Address]nogoutil.Amount,
	...
	cmd := nogojson.NewSendManyCmd(fromAccount, convertedAmounts,
		&minConfirms, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[address.Address]nogoutil.Amount, minConfirms int,
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int,
	...
	cmd := nogojson.NewAddMultisigAddressCmd(requiredSigs, addrs, &account)
...
func (r FutureCreateMultisigResult) Receive() (*nogojson.CreateMultiSigResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var multisigRes nogojson.CreateMultiSigResult
...
func (c *Client) CreateMultisigAsync(requiredSigs int,
	...
	cmd := nogojson.NewCreateMultisigCmd(requiredSigs, addrs)
	return c.SendCmd(cmd)
}
...
func (c *Client) CreateMultisig(requiredSigs int,
	addresses []address.Address) (*nogojson.CreateMultiSigResult, error) {
...
func (c *Client) CreateNewAccountAsync(account string) FutureCreateNewAccountResult {
	cmd := nogojson.NewCreateNewAccountCmd(account)
	return c.SendCmd(cmd)
}
...
func (r FutureCreateWalletResult) Receive() (*nogojson.CreateWalletResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var createWalletResult nogojson.CreateWalletResult
...
// method.
type CreateWalletOpt func(*nogojson.CreateWalletCmd)
...
func WithCreateWalletDisablePrivateKeys() CreateWalletOpt {
	return func(c *nogojson.CreateWalletCmd) {
		c.DisablePrivateKeys = nogojson.Bool(true)
	}
}
...
func WithCreateWalletPassphrase(value string) CreateWalletOpt {
	return func(c *nogojson.CreateWalletCmd) {
		c.Passphrase = nogojson.String(value)
	}
}
...
func WithCreateWalletAvoidReuse() CreateWalletOpt {
	return func(c *nogojson.CreateWalletCmd) {
		c.AvoidReuse = nogojson.Bool(true)
	}
}
...
func (c *Client) CreateWalletAsync(name string, opts ...CreateWalletOpt) FutureCreateWalletResult {
	cmd := nogojson.NewCreateWalletCmd(name, nil, nil, nil, nil)
...
func (c *Client) CreateWallet(name string, opts ...CreateWalletOpt) (*nogojson.CreateWalletResult, error) {
...
func (r FutureGetAddressInfoResult) Receive() (*nogojson.GetAddressInfoResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var getAddressInfoResult nogojson.GetAddressInfoResult
...
func (c *Client) GetAddressInfoAsync(address string) FutureGetAddressInfoResult {
	cmd := nogojson.NewGetAddressInfoCmd(address)
	return c.SendCmd(cmd)
}

// GetAddressInfo returns information about the given bitcoin address.
func (c *Client) GetAddressInfo(address string) (*nogojson.GetAddressInfoResult, error) {
...
func (c *Client) GetNewAddressAsync(account string) FutureGetNewAddressResult {
	cmd := nogojson.NewGetNewAddressCmd(&account, nil)
...
func (c *Client) GetNewAddressTypeAsync(account, addrType string) FutureGetNewAddressResult {
	cmd := nogojson.NewGetNewAddressCmd(&account, &addrType)
	result := FutureGetNewAddressResult{
		network:         c.chainParams,
		responseChannel: c.SendCmd(cmd),
	}
...
func (c *Client) GetRawChangeAddressAsync(account string) FutureGetRawChangeAddressResult {
	cmd := nogojson.NewGetRawChangeAddressCmd(&account, nil)
...
func (c *Client) GetRawChangeAddressTypeAsync(account, addrType string) FutureGetRawChangeAddressResult {
	cmd := nogojson.NewGetRawChangeAddressCmd(&account, &addrType)
	result := FutureGetRawChangeAddressResult{
		network:         c.chainParams,
		responseChannel: c.SendCmd(cmd),
	}
...
func (c *Client) AddWitnessAddressAsync(address string) FutureAddWitnessAddressResult {
	cmd := nogojson.NewAddWitnessAddressCmd(address)
...
func (c *Client) GetAccountAddressAsync(account string) FutureGetAccountAddressResult {
	cmd := nogojson.NewGetAccountAddressCmd(account)
...
func (c *Client) GetAccountAsync(address address.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
	cmd := nogojson.NewGetAccountCmd(addr)
	return c.SendCmd(cmd)
}
...
func (c *Client) SetAccountAsync(address address.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
	cmd := nogojson.NewSetAccountCmd(addr, account)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetAddressesByAccountAsync(account string) FutureGetAddressesByAccountResult {
	cmd := nogojson.NewGetAddressesByAccountCmd(account)
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount nogoutil.Amount) FutureMoveResult {
	cmd := nogojson.NewMoveCmd(fromAccount, toAccount, amount.ToBTC(), nil,
		nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) Move(fromAccount, toAccount string, amount nogoutil.Amount) (bool, error) {
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	amount nogoutil.Amount, minConfirms int) FutureMoveResult {

	cmd := nogojson.NewMoveCmd(fromAccount, toAccount, amount.ToBTC(),
		&minConfirms, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount nogoutil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveCommentAsync(fromAccount, toAccount string,
	amount nogoutil.Amount, minConfirms int, comment string) FutureMoveResult {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount nogoutil.Amount,
...
func (c *Client) RenameAccountAsync(oldAccount, newAccount string) FutureRenameAccountResult {
	cmd := nogojson.NewRenameAccountCmd(oldAccount, newAccount)
	return c.SendCmd(cmd)
}
...
// about the given bitcoin address.
func (r FutureValidateAddressResult) Receive() (*nogojson.ValidateAddressWalletResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var addrResult nogojson.ValidateAddressWalletResult
...
func (c *Client) ValidateAddressAsync(
	...
	addr := address.EncodeAddress()
	cmd := nogojson.NewValidateAddressCmd(addr)
	return c.SendCmd(cmd)
}

// ValidateAddress returns information about the given bitcoin address.
func (c *Client) ValidateAddress(
	address address.Address) (*nogojson.ValidateAddressWalletResult, error) {
...
func (c *Client) KeyPoolRefillAsync() FutureKeyPoolRefillResult {
	cmd := nogojson.NewKeyPoolRefillCmd(nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) KeyPoolRefillSizeAsync(newSize uint) FutureKeyPoolRefillResult {
	cmd := nogojson.NewKeyPoolRefillCmd(&newSize)
	return c.SendCmd(cmd)
}
...
func (r FutureListAccountsResult) Receive() (map[string]nogoutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]nogoutil.Amount)
	for k, v := range accounts {
		amount, err := nogoutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccountsAsync() FutureListAccountsResult {
	cmd := nogojson.NewListAccountsCmd(nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListAccounts() (map[string]nogoutil.Amount, error) {
...
func (c *Client) ListAccountsMinConfAsync(minConfirms int) FutureListAccountsResult {
	cmd := nogojson.NewListAccountsCmd(&minConfirms)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]nogoutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (nogoutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := nogoutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the Response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (nogoutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalanceAsync(account string) FutureGetBalanceResult {
	cmd := nogojson.NewGetBalanceCmd(&account, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetBalance(account string) (nogoutil.Amount, error) {
...
func (c *Client) GetBalanceMinConfAsync(account string, minConfirms int) FutureGetBalanceResult {
	cmd := nogojson.NewGetBalanceCmd(&account, &minConfirms)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (nogoutil.Amount, error) {
...
func (r FutureGetBalancesResult) Receive() (*nogojson.GetBalancesResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a floating point number.
	var balances nogojson.GetBalancesResult
...
func (c *Client) GetBalancesAsync() FutureGetBalancesResult {
	cmd := nogojson.NewGetBalancesCmd()
	return c.SendCmd(cmd)
}

// GetBalances returns the available balances from the server.
func (c *Client) GetBalances() (*nogojson.GetBalancesResult, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (nogoutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAccountAsync(account string) FutureGetReceivedByAccountResult {
	cmd := nogojson.NewGetReceivedByAccountCmd(account, nil)
	return c.SendCmd(cmd)
}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (nogoutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConfAsync(account string, minConfirms int) FutureGetReceivedByAccountResult {
	cmd := nogojson.NewGetReceivedByAccountCmd(account, &minConfirms)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (nogoutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (nogoutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalanceAsync(account string) FutureGetUnconfirmedBalanceResult {
	cmd := nogojson.NewGetUnconfirmedBalanceCmd(&account)
	return c.SendCmd(cmd)
}

// GetUnconfirmedBalance returns the unconfirmed balance from the server for
// the specified account.
func (c *Client) GetUnconfirmedBalance(account string) (nogoutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (nogoutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(
	...
	addr := address.EncodeAddress()
	cmd := nogojson.NewGetReceivedByAddressCmd(addr, nil)
	return c.SendCmd(cmd)
...
// confirmations.
func (c *Client) GetReceivedByAddress(address address.Address) (nogoutil.Amount,
	error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address address.Address,
	...
	addr := address.EncodeAddress()
	cmd := nogojson.NewGetReceivedByAddressCmd(addr, &minConfirms)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetReceivedByAddressMinConf(address address.Address,
	minConfirms int) (nogoutil.Amount, error) {
...
// Receive waits for the Response promised by the future and returns a list of
// balances by account.
func (r FutureListReceivedByAccountResult) Receive() ([]nogojson.ListReceivedByAccountResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []nogojson.ListReceivedByAccountResult
...
func (c *Client) ListReceivedByAccountAsync() FutureListReceivedByAccountResult {
	cmd := nogojson.NewListReceivedByAccountCmd(nil, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccount() ([]nogojson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountMinConfAsync(minConfirms int) FutureListReceivedByAccountResult {
	cmd := nogojson.NewListReceivedByAccountCmd(&minConfirms, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountMinConf(minConfirms int) ([]nogojson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountIncludeEmptyAsync(minConfirms int, includeEmpty bool) FutureListReceivedByAccountResult {
	cmd := nogojson.NewListReceivedByAccountCmd(&minConfirms, &includeEmpty,
		nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountIncludeEmpty(minConfirms int, includeEmpty bool) ([]nogojson.ListReceivedByAccountResult, error) {
...
// Receive waits for the Response promised by the future and returns a list of
// balances by address.
func (r FutureListReceivedByAddressResult) Receive() ([]nogojson.ListReceivedByAddressResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []nogojson.ListReceivedByAddressResult
	err = json.Unmarshal(res, &received)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListReceivedByAddressAsync() FutureListReceivedByAddressResult {
	cmd := nogojson.NewListReceivedByAddressCmd(nil, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddress() ([]nogojson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressMinConfAsync(minConfirms int) FutureListReceivedByAddressResult {
	cmd := nogojson.NewListReceivedByAddressCmd(&minConfirms, nil, nil)
	return c.SendCmd(cmd)
}
...
// received any payments in the results.
func (c *Client) ListReceivedByAddressMinConf(minConfirms int) ([]nogojson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressIncludeEmptyAsync(minConfirms int, includeEmpty bool) FutureListReceivedByAddressResult {
	cmd := nogojson.NewListReceivedByAddressCmd(&minConfirms, &includeEmpty,
		nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddressIncludeEmpty(minConfirms int, includeEmpty bool) ([]nogojson.ListReceivedByAddressResult, error) {
...
func (c *Client) WalletPassphrase(passphrase string, timeoutSecs int64) error {
	cmd := nogojson.NewWalletPassphraseCmd(passphrase, timeoutSecs)
...
func (c *Client) WalletPassphraseChangeAsync(old, new string) FutureWalletPassphraseChangeResult {
	cmd := nogojson.NewWalletPassphraseChangeCmd(old, new)
	return c.SendCmd(cmd)
}
...
func (c *Client) SignMessageAsync(address address.Address,
	...
	addr := address.EncodeAddress()
	cmd := nogojson.NewSignMessageCmd(addr, message)
	return c.SendCmd(cmd)
}
...
func (c *Client) VerifyMessageAsync(address address.Address, signature,
	...
	addr := address.EncodeAddress()
	cmd := nogojson.NewVerifyMessageCmd(addr, signature, message)
	return c.SendCmd(cmd)
}
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*nogoutil.WIF, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return nogoutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(
	...
	addr := address.EncodeAddress()
	cmd := nogojson.NewDumpPrivKeyCmd(addr)
	return c.SendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address address.Address) (*nogoutil.WIF, error) {
...
func (c *Client) ImportAddressAsync(address string) FutureImportAddressResult {
	cmd := nogojson.NewImportAddressCmd(address, "", nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ImportAddressRescanAsync(address string, account string, rescan bool) FutureImportAddressResult {
	cmd := nogojson.NewImportAddressCmd(address, account, &rescan)
	return c.SendCmd(cmd)
}
...
func (r FutureImportMultiResult) Receive() (nogojson.ImportMultiResults, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var importMultiResults nogojson.ImportMultiResults
...
func (c *Client) ImportMultiAsync(requests []nogojson.ImportMultiRequest, options *nogojson.ImportMultiOptions) FutureImportMultiResult {
	cmd := nogojson.NewImportMultiCmd(requests, options)
	return c.SendCmd(cmd)
}
...
//
// See nogojson.ImportMultiRequest for details on the requests parameter.
func (c *Client) ImportMulti(requests []nogojson.ImportMultiRequest, options *nogojson.ImportMultiOptions) (nogojson.ImportMultiResults, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *nogoutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := nogojson.NewImportPrivKeyCmd(wif, nil, nil)
	return c.SendCmd(cmd)
}

// ImportPrivKey imports the passed private key which must be the wallet import
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *nogoutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *nogoutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := nogojson.NewImportPrivKeyCmd(wif, &label, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *nogoutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *nogoutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := nogojson.NewImportPrivKeyCmd(wif, &label, &rescan)
	return c.SendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *nogoutil.WIF, label string, rescan bool) error {
...
func (c *Client) ImportPubKeyAsync(pubKey string) FutureImportPubKeyResult {
	cmd := nogojson.NewImportPubKeyCmd(pubKey, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ImportPubKeyRescanAsync(pubKey string, rescan bool) FutureImportPubKeyResult {
	cmd := nogojson.NewImportPubKeyCmd(pubKey, &rescan)
	return c.SendCmd(cmd)
}
...
func (r FutureGetInfoResult) Receive() (*nogojson.InfoWalletResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes nogojson.InfoWalletResult
...
func (c *Client) GetInfo() (*nogojson.InfoWalletResult, error) {
...
func (r FutureWalletCreateFundedPsbtResult) Receive() (*nogojson.WalletCreateFundedPsbtResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a getinfo result object.
	var psbtRes nogojson.WalletCreateFundedPsbtResult
...
func (c *Client) WalletCreateFundedPsbtAsync(
	inputs []nogojson.PsbtInput, outputs []nogojson.PsbtOutput, locktime *uint32,
	options *nogojson.WalletCreateFundedPsbtOpts, bip32Derivs *bool,
) FutureWalletCreateFundedPsbtResult {
	cmd := nogojson.NewWalletCreateFundedPsbtCmd(inputs, outputs, locktime, options, bip32Derivs)
	return c.SendCmd(cmd)
}
...
func (c *Client) WalletCreateFundedPsbt(
	inputs []nogojson.PsbtInput, outputs []nogojson.PsbtOutput, locktime *uint32,
	options *nogojson.WalletCreateFundedPsbtOpts, bip32Derivs *bool,
) (*nogojson.WalletCreateFundedPsbtResult, error) {
...
func (r FutureWalletProcessPsbtResult) Receive() (*nogojson.WalletProcessPsbtResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a getinfo result object.
	var psbtRes nogojson.WalletProcessPsbtResult
	err = json.Unmarshal(res, &psbtRes)
	if err != nil {
		return nil, err
	}
...
func (c *Client) WalletProcessPsbtAsync(
	...
	cmd := nogojson.NewWalletProcessPsbtCmd(psbt, sign, nogojson.String(sighashType.String()), bip32Derivs)
	return c.SendCmd(cmd)
}
...
func (c *Client) WalletProcessPsbt(
	psbt string, sign *bool, sighashType SigHashType, bip32Derivs *bool,
) (*nogojson.WalletProcessPsbtResult, error) {
...
func (r FutureGetWalletInfoResult) Receive() (*nogojson.GetWalletInfoResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var getWalletInfoResult nogojson.GetWalletInfoResult
...
func (c *Client) GetWalletInfoAsync() FutureGetWalletInfoResult {
	cmd := nogojson.NewGetWalletInfoCmd()
	return c.SendCmd(cmd)
}

// GetWalletInfo returns various wallet state info.
func (c *Client) GetWalletInfo() (*nogojson.GetWalletInfoResult, error) {
...
func (c *Client) BackupWalletAsync(destination string) FutureBackupWalletResult {
	return c.SendCmd(nogojson.NewBackupWalletCmd(destination))
}
...
// Receive waits for the Response promised by the future
func (r FutureDumpWalletResult) Receive() (*nogojson.DumpWalletResult, error) {
	bytes, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var res nogojson.DumpWalletResult
...
func (c *Client) DumpWalletAsync(destination string) FutureDumpWalletResult {
	return c.SendCmd(nogojson.NewDumpWalletCmd(destination))
}

// DumpWallet dumps all wallet keys in a human-readable format to a server-side file.
func (c *Client) DumpWallet(destination string) (*nogojson.DumpWalletResult, error) {
...
func (c *Client) ImportWalletAsync(filename string) FutureImportWalletResult {
	return c.SendCmd(nogojson.NewImportWalletCmd(filename))
}
...
func (c *Client) UnloadWalletAsync(walletName *string) FutureUnloadWalletResult {
	return c.SendCmd(nogojson.NewUnloadWalletCmd(walletName))
}
...
// Receive waits for the Response promised by the future
func (r FutureLoadWalletResult) Receive() (*nogojson.LoadWalletResult, error) {
	bytes, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	var result nogojson.LoadWalletResult
...
func (c *Client) LoadWalletAsync(walletName string) FutureLoadWalletResult {
	return c.SendCmd(nogojson.NewLoadWalletCmd(walletName))
}

// LoadWallet loads a wallet from a wallet file or directory.
func (c *Client) LoadWallet(walletName string) (*nogojson.LoadWalletResult, error) {
