...
const (
	...
	defaultMaxFeeRate nogojson.BTCPerkvB = 0.1
)
...
func (r FutureGetRawTransactionResult) Receive() (*nogoutil.Tx, error) {
	...
	return nogoutil.NewTx(&msgTx), nil
}
...
func (c *Client) GetRawTransactionAsync(txHash *chainhash.Hash) FutureGetRawTransactionResult {
	...
	cmd := nogojson.NewGetRawTransactionCmd(hash, nogojson.Int(0))
...
// transaction.
func (c *Client) GetRawTransaction(txHash *chainhash.Hash) (*nogoutil.Tx, error) {
...
func (r FutureGetRawTransactionVerboseResult) Receive() (*nogojson.TxRawResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var rawTxResult nogojson.TxRawResult
...
func (c *Client) GetRawTransactionVerboseAsync(txHash *chainhash.Hash) FutureGetRawTransactionVerboseResult {
	...
	cmd := nogojson.NewGetRawTransactionCmd(hash, nogojson.Int(1))
	return c.SendCmd(cmd)
}
...
func (c *Client) GetRawTransactionVerbose(txHash *chainhash.Hash) (*nogojson.TxRawResult, error) {
...
func (r FutureDecodeRawTransactionResult) Receive() (*nogojson.TxRawResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) DecodeRawTransactionAsync(serializedTx []byte) FutureDecodeRawTransactionResult {
	...
	cmd := nogojson.NewDecodeRawTransactionCmd(txHex)
	return c.SendCmd(cmd)
}

// DecodeRawTransaction returns information about a transaction given its
// serialized bytes.
func (c *Client) DecodeRawTransaction(serializedTx []byte) (*nogojson.TxRawResult, error) {
...
func (r FutureFundRawTransactionResult) Receive() (*nogojson.FundRawTransactionResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var marshalled nogojson.FundRawTransactionResult
...
func (c *Client) FundRawTransactionAsync(tx *wire.MsgTx, opts nogojson.FundRawTransactionOpts, isWitness *bool) FutureFundRawTransactionResult {
	var txBuf bytes.Buffer
	if err := tx.Serialize(&txBuf); err != nil {
		return newFutureError(err)
	}

	cmd := nogojson.NewFundRawTransactionCmd(txBuf.Bytes(), opts, isWitness)
	return c.SendCmd(cmd)
}

// FundRawTransaction returns the result of trying to fund the given transaction with
// funds from the node wallet
func (c *Client) FundRawTransaction(tx *wire.MsgTx, opts nogojson.FundRawTransactionOpts, isWitness *bool) (*nogojson.FundRawTransactionResult, error) {
...
func (c *Client) CreateRawTransactionAsync(inputs []nogojson.TransactionInput,
	amounts map[address.Address]nogoutil.Amount, lockTime *int64) FutureCreateRawTransactionResult {

	convertedAmts := make(map[string]float64, len(amounts))
	for addr, amount := range amounts {
		convertedAmts[addr.String()] = amount.ToBTC()
	}
	cmd := nogojson.NewCreateRawTransactionCmd(inputs, convertedAmts, lockTime)
	return c.SendCmd(cmd)
}
...
func (c *Client) CreateRawTransaction(inputs []nogojson.TransactionInput,
	amounts map[address.Address]nogoutil.Amount, lockTime *int64) (*wire.MsgTx, error) {
...
func (c *Client) SendRawTransactionAsync(tx *wire.MsgTx, allowHighFees bool) FutureSendRawTransactionResult {
	...
	var cmd *nogojson.SendRawTransactionCmd
	...
	if version.SupportUnifiedSoftForks() {
		...
		var maxFeeRate nogojson.BTCPerkvB
		if !allowHighFees {
			maxFeeRate = defaultMaxFeeRate
		}
		cmd = nogojson.NewBitcoindSendRawTransactionCmd(txHex, maxFeeRate)
	} else {
		// Otherwise, use the AllowHighFees field.
		cmd = nogojson.NewSendRawTransactionCmd(txHex, &allowHighFees)
	}
...
func (r FutureSignRawTransactionResult) Receive() (*wire.MsgTx, bool, error) {
	...
	var signRawTxResult nogojson.SignRawTransactionResult
...
func (c *Client) SignRawTransactionAsync(tx *wire.MsgTx) FutureSignRawTransactionResult {
	...
	cmd := nogojson.NewSignRawTransactionCmd(txHex, nil, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) SignRawTransaction2Async(tx *wire.MsgTx, inputs []nogojson.RawTxInput) FutureSignRawTransactionResult {
	txHex := ""
	if tx != nil {
		// Serialize the transaction and convert to hex string.
		buf := bytes.NewBuffer(make([]byte, 0, tx.SerializeSize()))
	...
	cmd := nogojson.NewSignRawTransactionCmd(txHex, &inputs, nil, nil)
	return c.SendCmd(cmd)
}
...
// transactions.
func (c *Client) SignRawTransaction2(tx *wire.MsgTx, inputs []nogojson.RawTxInput) (*wire.MsgTx, bool, error) {
...
func (c *Client) SignRawTransaction3Async(tx *wire.MsgTx,
	...
	cmd := nogojson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) SignRawTransaction4Async(tx *wire.MsgTx,
	inputs []nogojson.RawTxInput, privKeysWIF []string,
	...
	cmd := nogojson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		nogojson.String(string(hashType)))
	return c.SendCmd(cmd)
}
...
func (r FutureSignRawTransactionWithWalletResult) Receive() (*wire.MsgTx, bool, error) {
	...
	var signRawTxWithWalletResult nogojson.SignRawTransactionWithWalletResult
...
func (c *Client) SignRawTransactionWithWalletAsync(tx *wire.MsgTx) FutureSignRawTransactionWithWalletResult {
	...
	cmd := nogojson.NewSignRawTransactionWithWalletCmd(txHex, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) SignRawTransactionWithWallet2Async(tx *wire.MsgTx,
	inputs []nogojson.RawTxWitnessInput) FutureSignRawTransactionWithWalletResult {
	...
	cmd := nogojson.NewSignRawTransactionWithWalletCmd(txHex, &inputs, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) SignRawTransactionWithWallet2(tx *wire.MsgTx,
	inputs []nogojson.RawTxWitnessInput) (*wire.MsgTx, bool, error) {
...
func (c *Client) SignRawTransactionWithWallet3Async(tx *wire.MsgTx,
	inputs []nogojson.RawTxWitnessInput, hashType SigHashType) FutureSignRawTransactionWithWalletResult {
	...
	cmd := nogojson.NewSignRawTransactionWithWalletCmd(txHex, &inputs, nogojson.String(string(hashType)))
	return c.SendCmd(cmd)
}
...
func (c *Client) SignRawTransactionWithWallet3(tx *wire.MsgTx,
	inputs []nogojson.RawTxWitnessInput, hashType SigHashType) (*wire.MsgTx, bool, error) {
...
func (c *Client) SearchRawTransactionsAsync(address address.Address, skip,
	...
	cmd := nogojson.NewSearchRawTransactionsCmd(addr, verbose, &skip, &count,
...
// Receive waits for the Response promised by the future and returns the
// found raw transactions.
func (r FutureSearchRawTransactionsVerboseResult) Receive() ([]*nogojson.SearchRawTransactionsResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var result []*nogojson.SearchRawTransactionsResult
...
func (c *Client) SearchRawTransactionsVerbose(address address.Address, skip,
	count int, includePrevOut, reverse bool,
	filterAddrs []string) ([]*nogojson.SearchRawTransactionsResult, error) {
...
func (r FutureDecodeScriptResult) Receive() (*nogojson.DecodeScriptResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var decodeScriptResult nogojson.DecodeScriptResult
...
func (c *Client) DecodeScriptAsync(serializedScript []byte) FutureDecodeScriptResult {
	...
	cmd := nogojson.NewDecodeScriptCmd(scriptHex)
	return c.SendCmd(cmd)
}

// DecodeScript returns information about a script given its serialized bytes.
func (c *Client) DecodeScript(serializedScript []byte) (*nogojson.DecodeScriptResult, error) {
...
func (r FutureTestMempoolAcceptResult) Receive() (
	[]*nogojson.TestMempoolAcceptResult, error) {
	...
	var results []*nogojson.TestMempoolAcceptResult
...
func (c *Client) TestMempoolAcceptAsync(txns []*wire.MsgTx,
	maxFeeRate nogojson.BTCPerkvB) FutureTestMempoolAcceptResult {
	...
	cmd := nogojson.NewTestMempoolAcceptCmd(rawTxns, maxFeeRate)
...
func (c *Client) TestMempoolAccept(txns []*wire.MsgTx,
	maxFeeRate nogojson.BTCPerkvB) ([]*nogojson.TestMempoolAcceptResult, error) {
...
func (r FutureSubmitPackageResult) Receive() (*nogojson.SubmitPackageResult,
	error) {
	...
	// nogojson.SubmitPackageResult implements a custom UnmarshalJSON that
	// maps the raw submitpackage response into higher-level types.
	var result nogojson.SubmitPackageResult
...
func (c *Client) SubmitPackageAsync(txns []*wire.MsgTx,
	...
	cmd := nogojson.NewJsonSubmitPackageCmd(
...
func (c *Client) SubmitPackage(txns []*wire.MsgTx,
	maxFeeRate, maxBurnAmount *float64) (*nogojson.SubmitPackageResult,
	error) {
...
func (r FutureGetTxSpendingPrevOut) Receive() (
	[]*nogojson.GetTxSpendingPrevOutResult, error) {
	...
	var results []*nogojson.GetTxSpendingPrevOutResult
...
func (c *Client) GetTxSpendingPrevOutAsync(
	...
	cmd := nogojson.NewGetTxSpendingPrevOutCmd(outpoints)
