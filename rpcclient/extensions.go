...
func (c *Client) DebugLevelAsync(levelSpec string) FutureDebugLevelResult {
	cmd := nogojson.NewDebugLevelCmd(levelSpec)
...
func (c *Client) CreateEncryptedWalletAsync(passphrase string) FutureCreateEncryptedWalletResult {
	cmd := nogojson.NewCreateEncryptedWalletCmd(passphrase)
	return c.SendCmd(cmd)
}
...
func (r FutureListAddressTransactionsResult) Receive() ([]nogojson.ListTransactionsResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListAddressTransactionsAsync(addresses []address.Address,
	...
	cmd := nogojson.NewListAddressTransactionsCmd(addrs, &account)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListAddressTransactions(addresses []address.Address,
	account string) ([]nogojson.ListTransactionsResult, error) {
...
func (r FutureGetBestBlockResult) Receive() (*chainhash.Hash, int32, error) {
	...
	var bestBlock nogojson.GetBestBlockResult
...
func (c *Client) GetBestBlockAsync() FutureGetBestBlockResult {
	cmd := nogojson.NewGetBestBlockCmd()
	return c.SendCmd(cmd)
}
...
func (c *Client) GetCurrentNetAsync() FutureGetCurrentNetResult {
	cmd := nogojson.NewGetCurrentNetCmd()
	return c.SendCmd(cmd)
}
...
func (c *Client) GetHeadersAsync(blockLocators []chainhash.Hash, hashStop *chainhash.Hash) FutureGetHeadersResult {
	...
	cmd := nogojson.NewGetHeadersCmd(locators, hash)
	return c.SendCmd(cmd)
}
...
func (c *Client) ExportWatchingWalletAsync(account string) FutureExportWatchingWalletResult {
	cmd := nogojson.NewExportWatchingWalletCmd(&account, nogojson.Bool(true))
	return c.SendCmd(cmd)
}
...
// Receive waits for the Response promised by the future and returns the
// session result.
func (r FutureSessionResult) Receive() (*nogojson.SessionResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var session nogojson.SessionResult
...
//
// NOTE: This is a btcsuite extension.
func (c *Client) Session() (*nogojson.SessionResult, error) {
...
// NOTE: This is a btcsuite extension ported from
// github.com/decred/dcrrpcclient.
func (r FutureVersionResult) Receive() (map[string]nogojson.VersionResult,
	error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	...
	var vr map[string]nogojson.VersionResult
...
// NOTE: This is a btcsuite extension ported from
// github.com/decred/dcrrpcclient.
func (c *Client) Version() (map[string]nogojson.VersionResult, error) {
