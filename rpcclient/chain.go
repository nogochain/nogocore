...
func (c *Client) GetBestBlockHashAsync() FutureGetBestBlockHashResult {
	cmd := nogojson.NewGetBestBlockHashCmd()
...
func (c *Client) legacyGetBlockRequest(hash string, verbose,
	...
	verboseJSON, err := json.Marshal(nogojson.Bool(verbose))
	if err != nil {
		return nil, err
	}
	verboseTxJSON, err := json.Marshal(nogojson.Bool(verboseTx))
	if err != nil {
		return nil, err
	}
...
func (c *Client) waitForGetBlockRes(respChan chan *Response, hash string,
	...
	if err, ok := err.(*nogojson.RPCError); ok &&
		err.Code == nogojson.ErrRPCInvalidParams.Code {
...
func (c *Client) GetBlockAsync(blockHash *chainhash.Hash) FutureGetBlockResult {
	...
	cmd := nogojson.NewGetBlockCmd(hash, nogojson.Int(0))
...
func (r FutureGetBlockVerboseResult) Receive() (*nogojson.GetBlockVerboseResult, error) {
	...
	var blockResult nogojson.GetBlockVerboseResult
...
func (c *Client) GetBlockVerboseAsync(blockHash *chainhash.Hash) FutureGetBlockVerboseResult {
	...
	cmd := nogojson.NewGetBlockCmd(hash, nogojson.Int(1))
...
func (c *Client) GetBlockVerbose(blockHash *chainhash.Hash) (*nogojson.GetBlockVerboseResult, error) {
...
func (r FutureGetBlockVerboseTxResult) Receive() (*nogojson.GetBlockVerboseTxResult, error) {
	res, err := r.client.waitForGetBlockRes(r.Response, r.hash, true, true)
	if err != nil {
		return nil, err
	}

	var blockResult nogojson.GetBlockVerboseTxResult
	err = json.Unmarshal(res, &blockResult)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetBlockVerboseTxAsync(blockHash *chainhash.Hash) FutureGetBlockVerboseTxResult {
	...
	cmd := nogojson.NewGetBlockCmd(hash, nogojson.Int(2))
...
// See GetBlock to retrieve a raw block instead.
func (c *Client) GetBlockVerboseTx(blockHash *chainhash.Hash) (*nogojson.GetBlockVerboseTxResult, error) {
...
func (c *Client) GetBlockCountAsync() FutureGetBlockCountResult {
	cmd := nogojson.NewGetBlockCountCmd()
	return c.SendCmd(cmd)
}
...
func (r FutureGetChainTxStatsResult) Receive() (*nogojson.GetChainTxStatsResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var chainTxStats nogojson.GetChainTxStatsResult
...
func (c *Client) GetChainTxStatsAsync() FutureGetChainTxStatsResult {
	cmd := nogojson.NewGetChainTxStatsCmd(nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetChainTxStatsNBlocksAsync(nBlocks int32) FutureGetChainTxStatsResult {
	cmd := nogojson.NewGetChainTxStatsCmd(&nBlocks, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetChainTxStatsNBlocksBlockHashAsync(nBlocks int32, blockHash chainhash.Hash) FutureGetChainTxStatsResult {
	hash := blockHash.String()
	cmd := nogojson.NewGetChainTxStatsCmd(&nBlocks, &hash)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetChainTxStats() (*nogojson.GetChainTxStatsResult, error) {
...
func (c *Client) GetChainTxStatsNBlocks(nBlocks int32) (*nogojson.GetChainTxStatsResult, error) {
...
func (c *Client) GetChainTxStatsNBlocksBlockHash(nBlocks int32, blockHash chainhash.Hash) (*nogojson.GetChainTxStatsResult, error) {
...
func (c *Client) GetDifficultyAsync() FutureGetDifficultyResult {
	cmd := nogojson.NewGetDifficultyCmd()
	return c.SendCmd(cmd)
}
...
func unmarshalPartialGetBlockChainInfoResult(res []byte) (*nogojson.GetBlockChainInfoResult, error) {
	var chainInfo nogojson.GetBlockChainInfoResult
...
func unmarshalGetBlockChainInfoResultSoftForks(chainInfo *nogojson.GetBlockChainInfoResult,
	...
	if version.SupportUnifiedSoftForks() {
		var softForks nogojson.UnifiedSoftForks
		...
		var softForks nogojson.SoftForks
		if err := json.Unmarshal(res, &softForks); err != nil {
			return err
		}
...
func (r FutureGetBlockChainInfoResult) Receive() (*nogojson.GetBlockChainInfoResult, error) {
...
func (c *Client) GetBlockChainInfoAsync() FutureGetBlockChainInfoResult {
	cmd := nogojson.NewGetBlockChainInfoCmd()
...
// of the main chain.
func (c *Client) GetBlockChainInfo() (*nogojson.GetBlockChainInfoResult, error) {
...
// result provided by the server.
func (r FutureGetBlockFilterResult) Receive() (*nogojson.GetBlockFilterResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var blockFilter nogojson.GetBlockFilterResult
...
func (c *Client) GetBlockFilterAsync(blockHash chainhash.Hash, filterType *nogojson.FilterTypeName) FutureGetBlockFilterResult {
	hash := blockHash.String()

	cmd := nogojson.NewGetBlockFilterCmd(hash, filterType)
	return c.SendCmd(cmd)
}

// GetBlockFilter retrieves a BIP0157 content filter for a particular block.
func (c *Client) GetBlockFilter(blockHash chainhash.Hash, filterType *nogojson.FilterTypeName) (*nogojson.GetBlockFilterResult, error) {
...
func (c *Client) GetBlockHashAsync(blockHeight int64) FutureGetBlockHashResult {
	cmd := nogojson.NewGetBlockHashCmd(blockHeight)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderAsync(blockHash *chainhash.Hash) FutureGetBlockHeaderResult {
	...
	cmd := nogojson.NewGetBlockHeaderCmd(hash, nogojson.Bool(false))
	return c.SendCmd(cmd)
}
...
func (r FutureGetBlockHeaderVerboseResult) Receive() (*nogojson.GetBlockHeaderVerboseResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var bh nogojson.GetBlockHeaderVerboseResult
...
func (c *Client) GetBlockHeaderVerboseAsync(blockHash *chainhash.Hash) FutureGetBlockHeaderVerboseResult {
	...
	cmd := nogojson.NewGetBlockHeaderCmd(hash, nogojson.Bool(true))
	return c.SendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderVerbose(blockHash *chainhash.Hash) (*nogojson.GetBlockHeaderVerboseResult, error) {
...
func (r FutureGetChainTipsResult) Receive() ([]*nogojson.GetChainTipsResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a string.
	var chainTips []*nogojson.GetChainTipsResult
...
func (c *Client) GetChainTipsAsync() FutureGetChainTipsResult {
	cmd := nogojson.NewGetChainTipsCmd()
	return c.SendCmd(cmd)
}
...
func (c *Client) GetChainTips() ([]*nogojson.GetChainTipsResult, error) {
...
// its hash.
func (r FutureGetMempoolEntryResult) Receive() (*nogojson.GetMempoolEntryResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var mempoolEntryResult nogojson.GetMempoolEntryResult
...
func (c *Client) GetMempoolEntryAsync(txHash string) FutureGetMempoolEntryResult {
	cmd := nogojson.NewGetMempoolEntryCmd(txHash)
	return c.SendCmd(cmd)
}

// GetMempoolEntry returns a data structure with information about the
// transaction in the memory pool given its hash.
func (c *Client) GetMempoolEntry(txHash string) (*nogojson.GetMempoolEntryResult, error) {
...
func (c *Client) GetRawMempoolAsync() FutureGetRawMempoolResult {
	cmd := nogojson.NewGetRawMempoolCmd(nogojson.Bool(false))
	return c.SendCmd(cmd)
}
...
func (r FutureGetRawMempoolVerboseResult) Receive() (map[string]nogojson.GetRawMempoolVerboseResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// results.
	var mempoolItems map[string]nogojson.GetRawMempoolVerboseResult
...
func (c *Client) GetRawMempoolVerboseAsync() FutureGetRawMempoolVerboseResult {
	cmd := nogojson.NewGetRawMempoolCmd(nogojson.Bool(true))
	return c.SendCmd(cmd)
}
...
func (c *Client) GetRawMempoolVerbose() (map[string]nogojson.GetRawMempoolVerboseResult, error) {
...
func (c *Client) EstimateFeeAsync(numBlocks int64) FutureEstimateFeeResult {
	cmd := nogojson.NewEstimateFeeCmd(numBlocks)
	return c.SendCmd(cmd)
}
...
// Receive waits for the Response promised by the future and returns the
// estimated fee.
func (r FutureEstimateSmartFeeResult) Receive() (*nogojson.EstimateSmartFeeResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var verified nogojson.EstimateSmartFeeResult
...
func (c *Client) EstimateSmartFeeAsync(confTarget int64, mode *nogojson.EstimateSmartFeeMode) FutureEstimateSmartFeeResult {
	cmd := nogojson.NewEstimateSmartFeeCmd(confTarget, mode)
	return c.SendCmd(cmd)
}

// EstimateSmartFee requests the server to estimate a fee level based on the given parameters.
func (c *Client) EstimateSmartFee(confTarget int64, mode *nogojson.EstimateSmartFeeMode) (*nogojson.EstimateSmartFeeResult, error) {
...
func (c *Client) VerifyChainAsync() FutureVerifyChainResult {
	cmd := nogojson.NewVerifyChainCmd(nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) VerifyChainLevelAsync(checkLevel int32) FutureVerifyChainResult {
	cmd := nogojson.NewVerifyChainCmd(&checkLevel, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) VerifyChainBlocksAsync(checkLevel, numBlocks int32) FutureVerifyChainResult {
	cmd := nogojson.NewVerifyChainCmd(&checkLevel, &numBlocks)
	return c.SendCmd(cmd)
}
...
func (r FutureGetTxOutResult) Receive() (*nogojson.GetTxOutResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var txOutInfo *nogojson.GetTxOutResult
...
func (c *Client) GetTxOutAsync(txHash *chainhash.Hash, index uint32, mempool bool) FutureGetTxOutResult {
	...
	cmd := nogojson.NewGetTxOutCmd(hash, index, &mempool)
	return c.SendCmd(cmd)
}

// GetTxOut returns the transaction output info if it's unspent and
// nil, otherwise.
func (c *Client) GetTxOut(txHash *chainhash.Hash, index uint32, mempool bool) (*nogojson.GetTxOutResult, error) {
...
func (r FutureGetTxOutSetInfoResult) Receive() (*nogojson.GetTxOutSetInfoResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var txOutSetInfo *nogojson.GetTxOutSetInfoResult
...
func (c *Client) GetTxOutSetInfoAsync() FutureGetTxOutSetInfoResult {
	cmd := nogojson.NewGetTxOutSetInfoCmd()
	return c.SendCmd(cmd)
}

// GetTxOutSetInfo returns the statistics about the unspent transaction output
// set.
func (c *Client) GetTxOutSetInfo() (*nogojson.GetTxOutSetInfoResult, error) {
...
func (c *Client) GetTxOutProofAsync(txIDs []string,
	...
	cmd := nogojson.NewGetTxOutProofCmd(txIDs, blockHash)
	return c.SendCmd(cmd)
}
...
// NOTE: This is a btcsuite extension ported from
// github.com/decred/dcrrpcclient.
func (r FutureRescanBlocksResult) Receive() ([]nogojson.RescannedBlock, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var rescanBlocksResult []nogojson.RescannedBlock
...
func (c *Client) RescanBlocksAsync(blockHashes []chainhash.Hash) FutureRescanBlocksResult {
	...
	cmd := nogojson.NewRescanBlocksCmd(strBlockHashes)
	return c.SendCmd(cmd)
}
...
// NOTE: This is a btcsuite extension ported from
// github.com/decred/dcrrpcclient.
func (c *Client) RescanBlocks(blockHashes []chainhash.Hash) ([]nogojson.RescannedBlock, error) {
...
func (c *Client) InvalidateBlockAsync(blockHash *chainhash.Hash) FutureInvalidateBlockResult {
	...
	cmd := nogojson.NewInvalidateBlockCmd(hash)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetCFilterAsync(blockHash *chainhash.Hash,
	...
	cmd := nogojson.NewGetCFilterCmd(hash, filterType)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetCFilterHeaderAsync(blockHash *chainhash.Hash,
	...
	cmd := nogojson.NewGetCFilterHeaderCmd(hash, filterType)
	return c.SendCmd(cmd)
}
...
func (r FutureGetBlockStatsResult) Receive() (*nogojson.GetBlockStatsResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var blockStats nogojson.GetBlockStatsResult
...
func (c *Client) GetBlockStatsAsync(hashOrHeight interface{}, stats *[]string) FutureGetBlockStatsResult {
	...
	cmd := nogojson.NewGetBlockStatsCmd(nogojson.HashOrHeight{Value: hashOrHeight}, stats)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetBlockStats(hashOrHeight interface{}, stats *[]string) (*nogojson.GetBlockStatsResult, error) {
...
func (r FutureDeriveAddressesResult) Receive() (*nogojson.DeriveAddressesResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var deriveAddressesResult nogojson.DeriveAddressesResult
...
func (c *Client) DeriveAddressesAsync(descriptor string, descriptorRange *nogojson.DescriptorRange) FutureDeriveAddressesResult {
	cmd := nogojson.NewDeriveAddressesCmd(descriptor, descriptorRange)
	return c.SendCmd(cmd)
}
...
func (c *Client) DeriveAddresses(descriptor string, descriptorRange *nogojson.DescriptorRange) (*nogojson.DeriveAddressesResult, error) {
...
func (r FutureGetDescriptorInfoResult) Receive() (*nogojson.GetDescriptorInfoResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var descriptorInfo nogojson.GetDescriptorInfoResult
...
func (c *Client) GetDescriptorInfoAsync(descriptor string) FutureGetDescriptorInfoResult {
	cmd := nogojson.NewGetDescriptorInfoCmd(descriptor)
	return c.SendCmd(cmd)
}
...
//
// See nogojson.GetDescriptorInfoResult for details about the result.
func (c *Client) GetDescriptorInfo(descriptor string) (*nogojson.GetDescriptorInfoResult, error) {
...
func (c *Client) ReconsiderBlockAsync(
	...
	cmd := nogojson.NewReconsiderBlockCmd(hash)
	return c.SendCmd(cmd)
}
