...
func (c *Client) AddNodeAsync(host string, command AddNodeCommand) FutureAddNodeResult {
	cmd := nogojson.NewAddNodeCmd(host, nogojson.AddNodeSubCmd(command))
...
func (c *Client) NodeAsync(command nogojson.NodeSubCmd, host string,
	connectSubCmd *string) FutureNodeResult {
	cmd := nogojson.NewNodeCmd(command, host, connectSubCmd)
	return c.SendCmd(cmd)
}
...
func (c *Client) Node(command nogojson.NodeSubCmd, host string,
...
func (r FutureGetAddedNodeInfoResult) Receive() ([]nogojson.GetAddedNodeInfoResult, error) {
	...
	var nodeInfo []nogojson.GetAddedNodeInfoResult
...
func (c *Client) GetAddedNodeInfoAsync(peer string) FutureGetAddedNodeInfoResult {
	cmd := nogojson.NewGetAddedNodeInfoCmd(true, &peer)
	return c.SendCmd(cmd)
}
...
// peers.
func (c *Client) GetAddedNodeInfo(peer string) ([]nogojson.GetAddedNodeInfoResult, error) {
...
func (c *Client) GetAddedNodeInfoNoDNSAsync(peer string) FutureGetAddedNodeInfoNoDNSResult {
	cmd := nogojson.NewGetAddedNodeInfoCmd(false, &peer)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetConnectionCountAsync() FutureGetConnectionCountResult {
	cmd := nogojson.NewGetConnectionCountCmd()
	return c.SendCmd(cmd)
}
...
// the current network.
func (r FutureGetNetworkInfoResult) Receive() (*nogojson.GetNetworkInfoResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var networkInfo nogojson.GetNetworkInfoResult
...
func (c *Client) GetNetworkInfoAsync() FutureGetNetworkInfoResult {
	cmd := nogojson.NewGetNetworkInfoCmd()
	return c.SendCmd(cmd)
}

// GetNetworkInfo returns data about the current network.
func (c *Client) GetNetworkInfo() (*nogojson.GetNetworkInfoResult, error) {
...
func (r FutureGetNodeAddressesResult) Receive() ([]nogojson.GetNodeAddressesResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var nodeAddresses []nogojson.GetNodeAddressesResult
...
func (c *Client) GetNodeAddressesAsync(count *int32) FutureGetNodeAddressesResult {
	cmd := nogojson.NewGetNodeAddressesCmd(count)
	return c.SendCmd(cmd)
}

// GetNodeAddresses returns data about known node addresses.
func (c *Client) GetNodeAddresses(count *int32) ([]nogojson.GetNodeAddressesResult, error) {
...
func (r FutureGetPeerInfoResult) Receive() ([]nogojson.GetPeerInfoResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as an array of getpeerinfo result objects.
	var peerInfo []nogojson.GetPeerInfoResult
...
func (c *Client) GetPeerInfoAsync() FutureGetPeerInfoResult {
	cmd := nogojson.NewGetPeerInfoCmd()
	return c.SendCmd(cmd)
}

// GetPeerInfo returns data about each connected network peer.
func (c *Client) GetPeerInfo() ([]nogojson.GetPeerInfoResult, error) {
...
// traffic statistics.
func (r FutureGetNetTotalsResult) Receive() (*nogojson.GetNetTotalsResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var totals nogojson.GetNetTotalsResult
...
func (c *Client) GetNetTotalsAsync() FutureGetNetTotalsResult {
	cmd := nogojson.NewGetNetTotalsCmd()
	return c.SendCmd(cmd)
}

// GetNetTotals returns network traffic statistics.
func (c *Client) GetNetTotals() (*nogojson.GetNetTotalsResult, error) {
