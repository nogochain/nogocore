...
func TestBtcWalletExtCmds(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			newCmd: func() (interface{}, error) {
				return nogojson.NewCmd("createnewaccount", "acct")
			},
			staticCmd: func() interface{} {
				return nogojson.NewCreateNewAccountCmd("acct")
			},
			marshalled: `{"jsonrpc":"1.0","method":"createnewaccount","params":["acct"],"id":1}`,
			unmarshalled: &nogojson.CreateNewAccountCmd{
				Account: "acct",
			},
		},
		{
			name: "dumpwallet",
			newCmd: func() (interface{}, error) {
				return nogojson.NewCmd("dumpwallet", "filename")
			},
			staticCmd: func() interface{} {
				return nogojson.NewDumpWalletCmd("filename")
			},
			marshalled: `{"jsonrpc":"1.0","method":"dumpwallet","params":["filename"],"id":1}`,
			unmarshalled: &nogojson.DumpWalletCmd{
				Filename: "filename",
			},
		},
		{
			name: "importaddress",
			newCmd: func() (interface{}, error) {
				return nogojson.NewCmd("importaddress", "1Address", "")
			},
			staticCmd: func() interface{} {
				return nogojson.NewImportAddressCmd("1Address", "", nil)
			},
			marshalled: `{"jsonrpc":"1.0","method":"importaddress","params":["1Address",""],"id":1}`,
			unmarshalled: &nogojson.ImportAddressCmd{
				Address: "1Address",
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return nogojson.NewCmd("importaddress", "1Address", "acct", false)
			},
			staticCmd: func() interface{} {
				return nogojson.NewImportAddressCmd("1Address", "acct", nogojson.Bool(false))
			},
		...
		},
		{
			name: "importpubkey",
			newCmd: func() (interface{}, error) {
				return nogojson.NewCmd("importpubkey", "031234")
			},
			staticCmd: func() interface{} {
				return nogojson.NewImportPubKeyCmd("031234", nil)
			},
			marshalled: `{"jsonrpc":"1.0","method":"importpubkey","params":["031234"],"id":1}`,
			unmarshalled: &nogojson.ImportPubKeyCmd{
				PubKey: "031234",
				Rescan: nogojson.Bool(true),
			},
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return nogojson.NewCmd("importpubkey", "031234", false)
			},
			staticCmd: func() interface{} {
				return nogojson.NewImportPubKeyCmd("031234", nogojson.Bool(false))
			},
		...
		},
		{
			name: "importwallet",
			newCmd: func() (interface{}, error) {
				return nogojson.NewCmd("importwallet", "filename")
			},
			staticCmd: func() interface{} {
				return nogojson.NewImportWalletCmd("filename")
			},
			marshalled: `{"jsonrpc":"1.0","method":"importwallet","params":["filename"],"id":1}`,
			unmarshalled: &nogojson.ImportWalletCmd{
				Filename: "filename",
			},
		},
		{
			name: "renameaccount",
			newCmd: func() (interface{}, error) {
				return nogojson.NewCmd("renameaccount", "oldacct", "newacct")
			},
			staticCmd: func() interface{} {
				return nogojson.NewRenameAccountCmd("oldacct", "newacct")
			},
			marshalled: `{"jsonrpc":"1.0","method":"renameaccount","params":["oldacct","newacct"],"id":1}`,
			unmarshalled: &nogojson.RenameAccountCmd{
				OldAccount: "oldacct",
				NewAccount: "newacct",
			},
		},
