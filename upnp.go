...
func (n *upnpNAT) AddPortMapping(protocol string, externalPort, internalPort int, description string, timeout int) (mappedExternalPort int, err error) {
	...
	// Port forwarded with wildcard; the router does not return the external port
	// explicitly in the response. miniupnpc just checks for error codes here.
...
func (n *upnpNAT) DeletePortMapping(protocol string, externalPort, internalPort int) (err error) {
	...
	// Router does not return explicit confirmation for port deletion.
	// UPnP standard treats absence of error as success.
	_ = response
	return
}
