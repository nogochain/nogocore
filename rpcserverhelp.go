...
var rpcResultTypes = map[string][]interface{}{
	...
	"decoderawtransaction":   {(*nogojson.TxRawDecodeResult)(nil)},
	"decodescript":           {(*nogojson.DecodeScriptResult)(nil)},
	"estimatefee":            {(*float64)(nil)},
	"generate":               {(*[]string)(nil)},
	"getaddednodeinfo":       {(*[]string)(nil), (*[]nogojson.GetAddedNodeInfoResult)(nil)},
	"getbestblock":           {(*nogojson.GetBestBlockResult)(nil)},
	"getbestblockhash":       {(*string)(nil)},
	"getblock":               {(*string)(nil), (*nogojson.GetBlockVerboseResult)(nil)},
	"getblockcount":          {(*int64)(nil)},
	"getblockhash":           {(*string)(nil)},
	"getblockheader":         {(*string)(nil), (*nogojson.GetBlockHeaderVerboseResult)(nil)},
	"getblocktemplate":       {(*nogojson.GetBlockTemplateResult)(nil), (*string)(nil), nil},
	"getblockchaininfo":      {(*nogojson.GetBlockChainInfoResult)(nil)},
	"getchaintips":           {(*[]nogojson.GetChainTipsResult)(nil)},
	...
	"getinfo":                {(*nogojson.InfoChainResult)(nil)},
	"getmempoolinfo":         {(*nogojson.GetMempoolInfoResult)(nil)},
	"getmininginfo":          {(*nogojson.GetMiningInfoResult)(nil)},
	"getnettotals":           {(*nogojson.GetNetTotalsResult)(nil)},
	"getnetworkhashps":       {(*float64)(nil)},
	"getnodeaddresses":       {(*[]nogojson.GetNodeAddressesResult)(nil)},
	"getpeerinfo":            {(*[]nogojson.GetPeerInfoResult)(nil)},
	"getrawmempool":          {(*[]string)(nil), (*nogojson.GetRawMempoolVerboseResult)(nil)},
	"getrawtransaction":      {(*string)(nil), (*nogojson.TxRawResult)(nil)},
	"gettxout":               {(*nogojson.GetTxOutResult)(nil)},
	"node":                   nil,
	"help":                   {(*string)(nil), (*string)(nil)},
	"invalidateblock":        nil,
	"ping":                   nil,
	"reconsiderblock":        nil,
	"searchrawtransactions":  {(*string)(nil), (*[]nogojson.SearchRawTransactionsResult)(nil)},
	...
	"uptime":                 {(*int64)(nil)},
	"validateaddress":        {(*nogojson.ValidateAddressChainResult)(nil)},
	"verifychain":            {(*bool)(nil)},
	"verifymessage":          {(*bool)(nil)},
	"version":                {(*map[string]nogojson.VersionResult)(nil)},
	"testmempoolaccept":      {(*[]nogojson.TestMempoolAcceptResult)(nil)},
	"gettxspendingprevout":   {(*[]nogojson.GetTxSpendingPrevOutResult)(nil)},

	// Websocket commands.
	"loadtxfilter":              nil,
	"session":                   {(*nogojson.SessionResult)(nil)},
	"notifyblocks":              nil,
	...
	"stopnotifyspent":           nil,
	"rescan":                    nil,
	"rescanblocks":              {(*[]nogojson.RescannedBlock)(nil)},
}
...
func (c *helpCacher) rpcMethodHelp(method string) (string, error) {
	...
	help, err := nogojson.GenerateHelp(method, helpDescsEnUS, resultTypes...)
	if err != nil {
		return "", err
	}
...
func (c *helpCacher) rpcUsage(includeWebsockets bool) (string, error) {
	...
	for k := range rpcHandlers {
		usage, err := nogojson.MethodUsageText(k)
		if err != nil {
			return "", err
		}
