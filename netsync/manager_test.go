...
func (noopPeerNotifier) TransactionConfirmed(*nogoutil.Tx)                     {}
...
func generateTestBlocks(
	t *testing.T, params *chaincfg.Params, count int) []*nogoutil.Block {

	t.Helper()

	blocks := make([]*nogoutil.Block, 0, count)
...
func syncSendHeaders(t *testing.T, sm *SyncManager,
	syncPeer *peer.Peer, blocks []*nogoutil.Block, totalBlocks int) {
...
func syncProcessBlocks(t *testing.T, sm *SyncManager, syncPeer *peer.Peer,
	blocks []*nogoutil.Block, totalBlocks int) {
...
func syncStalledPeerRecovery(t *testing.T, sm *SyncManager,
	...
	blocks []*nogoutil.Block, stallAfter, totalBlocks int) {
...
func syncStalledHeaderRecovery(t *testing.T, sm *SyncManager,
	stalledPeer, replacementPeer *peer.Peer,
	blocks []*nogoutil.Block, headersSent, totalBlocks int) {
