...
func (b *BlockChain) FetchSpendJournal(targetBlock *nogoutil.Block) ([]SpentTxOut, error) {
	b.chainLock.RLock()
...
func dbFetchSpendJournalEntry(dbTx database.Tx, block *nogoutil.Block) ([]SpentTxOut, error) {
...
func (b *BlockChain) createChainState() error {
	...
	genesisBlock := nogoutil.NewBlock(b.chainParams.GenesisBlock)
...
func (b *BlockChain) initChainState() error {
	...
	err = b.db.View(func(dbTx database.Tx) error {
		...
		blockWeight := uint64(GetBlockWeight(nogoutil.NewBlock(&block)))
...
// raw block for the provided node, deserialize it, and return a nogoutil.Block
// with the height set.
func dbFetchBlockByNode(dbTx database.Tx, node *blockNode) (*nogoutil.Block, error) {
	...
	block, err := nogoutil.NewBlockFromBytes(blockBytes)
	if err != nil {
		return nil, err
	}
...
func dbStoreBlock(dbTx database.Tx, block *nogoutil.Block) error {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHeight(blockHeight int32) (*nogoutil.Block, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHash(hash *chainhash.Hash) (*nogoutil.Block, error) {
