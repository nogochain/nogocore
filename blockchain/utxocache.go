...
func (s *utxoCache) addTxOuts(tx *nogoutil.Tx, blockHeight int32) error {
...
// from the cache.
func (s *utxoCache) addTxIns(tx *nogoutil.Tx, stxos *[]SpentTxOut) error {
...
func (s *utxoCache) connectTransaction(
	tx *nogoutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (s *utxoCache) connectTransactions(block *nogoutil.Block, stxos *[]SpentTxOut) error {
