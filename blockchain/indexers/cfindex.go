...
import (
	...
	"github.com/nogochain/nogocommons/nogoutil/gcs"
	"github.com/nogochain/nogocommons/nogoutil/gcs/builder"
...
func storeFilter(dbTx database.Tx, block *nogoutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *nogoutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *nogoutil.Block,
