...
const (
	...
	OP_RETURN = 0x6a
	// OP_DATA_36 pushes 36 bytes of data (0x24).
	OP_DATA_36 = 0x24
)
...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*nogoutil.Tx, witness bool) []*chainhash.Hash {
...
// also presents an additional case wherein the wtxid of the coinbase transaction
// is the zeroHash.
func CalcMerkleRoot(transactions []*nogoutil.Tx, witness bool) chainhash.Hash {
...
func ExtractWitnessCommitment(tx *nogoutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *nogoutil.Block) error {
