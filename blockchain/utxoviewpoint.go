...
// wire.TxOut instead.
//
// NOTE: This is an implementation of the PrevOutputFetcher interface.
...
func (view *UtxoViewpoint) AddTxOut(tx *nogoutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *nogoutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *nogoutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *nogoutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *nogoutil.Block, stxos []SpentTxOut) error {
...
// outpoints.
func (view *UtxoViewpoint) findInputsToFetch(block *nogoutil.Block) []wire.OutPoint {
...
// are not modified.
func (view *UtxoViewpoint) fetchInputUtxos(cache *utxoCache, block *nogoutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *nogoutil.Tx) (*UtxoViewpoint, error) {
